...
#
# Script generated by Vivado on Wed Jan 08 01:31:01 +0000 2025
...
#
# Usage        : ramTop.sh
#                ramTop.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ramTop.sh [-reset_run]
#                ramTop.sh [-reset_log]
#                ramTop.sh [-help]
#
...
#                script (type 'ramTop.sh -help' for more information).
#
...
# script info
echo -e "ramTop.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ramTop.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ramTop xil_defaultlib.glbl -o ramTop_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ramTop_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ramTop_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ramTop_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ramTop.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ramTop.sh [-help]\n\
Usage: ramTop.sh [-step]\n\
Usage: ramTop.sh [-lib_map_path]\n\
Usage: ramTop.sh [-reset_run]\n\
Usage: ramTop.sh [-reset_log]\n\
Usage: ramTop.sh [-keep_index]\n\
Usage: ramTop.sh [-noclean_files]\n\n\
