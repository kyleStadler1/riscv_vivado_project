...
#
# Script generated by Vivado on Thu Jan 09 07:21:42 +0000 2025
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : riscvTop.sh
...
#
# Usage        : riscvTop.sh
#                riscvTop.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                riscvTop.sh [-reset_run]
#                riscvTop.sh [-reset_log]
#                riscvTop.sh [-help]
#
...
#                script (type 'riscvTop.sh -help' for more information).
#
...
# script info
echo -e "riscvTop.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./riscvTop.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.riscvTop xil_defaultlib.glbl -o riscvTop_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./riscvTop_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key riscvTop_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc riscvTop_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./riscvTop.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: riscvTop.sh [-help]\n\
Usage: riscvTop.sh [-step]\n\
Usage: riscvTop.sh [-lib_map_path]\n\
Usage: riscvTop.sh [-reset_run]\n\
Usage: riscvTop.sh [-reset_log]\n\
Usage: riscvTop.sh [-keep_index]\n\
Usage: riscvTop.sh [-noclean_files]\n\n\
