...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot riscvTop xil_defaultlib.riscvTop xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim riscvTop -key {Behavioral:sim_1:Functional:riscvTop} -tclbatch cmd.tcl -protoinst "protoinst_files/riscvTop.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb riscvTop.wdb xsim.dir libdpi.so)
