...
#
# Script generated by Vivado on Fri Jan 10 11:51:57 +0000 2025
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : simpleRisc.sh
...
#
# Usage        : simpleRisc.sh
#                simpleRisc.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                simpleRisc.sh [-reset_run]
#                simpleRisc.sh [-reset_log]
#                simpleRisc.sh [-help]
#
...
#                script (type 'simpleRisc.sh -help' for more information).
#
...
# script info
echo -e "simpleRisc.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./simpleRisc.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.simpleRisc xil_defaultlib.glbl -o simpleRisc_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./simpleRisc_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/user/project/riscv2/genProject/riscv2/riscv2.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key simpleRisc_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc simpleRisc_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./simpleRisc.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: simpleRisc.sh [-help]\n\
Usage: simpleRisc.sh [-step]\n\
Usage: simpleRisc.sh [-lib_map_path]\n\
Usage: simpleRisc.sh [-reset_run]\n\
Usage: simpleRisc.sh [-reset_log]\n\
Usage: simpleRisc.sh [-keep_index]\n\
Usage: simpleRisc.sh [-noclean_files]\n\n\
