...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot simpleRisc xil_defaultlib.simpleRisc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim simpleRisc -key {Behavioral:sim_1:Functional:simpleRisc} -tclbatch cmd.tcl -protoinst "protoinst_files/simpleRisc.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb simpleRisc.wdb xsim.dir libdpi.so)
