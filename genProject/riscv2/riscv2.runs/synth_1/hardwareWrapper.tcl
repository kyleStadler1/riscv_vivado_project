...
namespace eval ::optrace {
  variable script "/home/user/project/riscv2/genProject/riscv2/riscv2.runs/synth_1/hardwareWrapper.tcl"
...
set_property used_in_implementation false [get_files /home/user/project/riscv2/constraints/constraints.xdc]

read_xdc dont_touch.xdc
set_property used_in_implementation false [get_files dont_touch.xdc]
set_param ips.enableIPCacheLiteLoad 1

read_checkpoint -auto_incremental -incremental /home/user/project/riscv2/genProject/riscv2/riscv2.srcs/utils_1/imports/synth_1/hardwareWrapper.dcp
close [open __synthesis_is_running__ w]

OPTRACE "synth_design" START { }
synth_design -top hardwareWrapper -part xc7z007sclg400-1
...
write_checkpoint -force -noxdef hardwareWrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file hardwareWrapper_utilization_synth.rpt -pb hardwareWrapper_utilization_synth.pb"
