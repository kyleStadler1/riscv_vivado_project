...
HD_PWD='/home/user/project/riscv2/riscv2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bramtest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bramtest.tcl
