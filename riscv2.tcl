...
#
# Generated by Vivado on Sun Jun 29 22:38:50 +0000 2025
...
#
#    "/home/user/project/riscv2/genProject/riscv2/riscv2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"
#    "/home/user/project/riscv2/genProject/riscv2/riscv2.srcs/utils_1/imports/synth_1/hardwareWrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/user/project/riscv2/src/aluMuxComb.v"
#    "/home/user/project/riscv2/src/opLatch.v"
#    "/home/user/project/riscv2/src/resetManager.v"
#    "/home/user/project/riscv2/src/writeBackLatch.v"
#    "/home/user/project/riscv2/src/Decode.v"
#    "/home/user/project/riscv2/src/memFetchLatch.v"
#    "/home/user/project/riscv2/src/bypassMux.v"
#    "/home/user/project/riscv2/src/RegFile.v"
#    "/home/user/project/riscv2/src/PC.v"
#    "/home/user/project/riscv2/src/execLatch.v"
#    "/home/user/project/riscv2/src/bytewrite_tdp_ram_rf.v"
#    "/home/user/project/riscv2/src/memInputLogic_.v"
#    "/home/user/project/riscv2/src/memOutputLogic.v"
#    "/home/user/project/riscv2/src/ExecStage.v"
#    "/home/user/project/riscv2/bd/riscWithPipeMem/hdl/riscWithPipeMem_wrapper.v"
#    "/home/user/project/riscv2/src/hardwareWrapper.v"
#    "/home/user/project/riscv2/src/bram_init.mem"
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/genProject/riscv2/riscv2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"]"\
 "[file normalize "$origin_dir/genProject/riscv2/riscv2.srcs/utils_1/imports/synth_1/hardwareWrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/src/aluMuxComb.v"]"\
 "[file normalize "$origin_dir/src/opLatch.v"]"\
 "[file normalize "$origin_dir/src/resetManager.v"]"\
 "[file normalize "$origin_dir/src/writeBackLatch.v"]"\
 "[file normalize "$origin_dir/src/Decode.v"]"\
 "[file normalize "$origin_dir/src/memFetchLatch.v"]"\
 "[file normalize "$origin_dir/src/bypassMux.v"]"\
 "[file normalize "$origin_dir/src/RegFile.v"]"\
 "[file normalize "$origin_dir/src/PC.v"]"\
 "[file normalize "$origin_dir/src/execLatch.v"]"\
 "[file normalize "$origin_dir/src/bytewrite_tdp_ram_rf.v"]"\
 "[file normalize "$origin_dir/src/memInputLogic_.v"]"\
 "[file normalize "$origin_dir/src/memOutputLogic.v"]"\
 "[file normalize "$origin_dir/src/ExecStage.v"]"\
 "[file normalize "$origin_dir/bd/riscWithPipeMem/hdl/riscWithPipeMem_wrapper.v"]"\
 "[file normalize "$origin_dir/src/hardwareWrapper.v"]"\
 "[file normalize "$origin_dir/src/bram_init.mem"]"\
...
set orig_proj_dir "[file normalize "$origin_dir/genProject/riscv2"]"
...
set_property -name "webtalk.xsim_launch_sim" -value "386" -objects $obj
...
set file "$origin_dir/src/aluMuxComb.v"
...
set file "$origin_dir/src/opLatch.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/resetManager.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/writeBackLatch.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/Decode.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/memFetchLatch.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/bypassMux.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/RegFile.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/execLatch.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/bytewrite_tdp_ram_rf.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/memInputLogic_.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/memOutputLogic.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/ExecStage.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/bd/riscWithPipeMem/hdl/riscWithPipeMem_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/hardwareWrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/bram_init.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
if { [get_files aluMuxComb.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/aluMuxComb.v
}
if { [get_files opLatch.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/opLatch.v
}
if { [get_files resetManager.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/resetManager.v
}
if { [get_files writeBackLatch.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/writeBackLatch.v
}
if { [get_files Decode.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/Decode.v
}
if { [get_files memFetchLatch.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/memFetchLatch.v
}
if { [get_files bypassMux.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/bypassMux.v
}
...
if { [get_files execLatch.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/execLatch.v
}
if { [get_files bytewrite_tdp_ram_rf.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/bytewrite_tdp_ram_rf.v
}
if { [get_files memInputLogic_.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/memInputLogic_.v
}
if { [get_files memOutputLogic.v] == "" } {
  import_files -quiet -fileset sources_1 /home/user/project/riscv2/src/memOutputLogic.v
}
...
# Proc to create BD riscWithPipeMem
proc cr_bd_riscWithPipeMem { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# aluMuxComb, opLatch, resetManager, writeBackLatch, Decode, memFetchLatch, bypassMux, new_reg_file, PC, execLatch, bytewrite_tdp_ram_rf, memInputLogic_, memOutputLogic, alu, pcAlu, pcMuxSelector



  # CHANGE DESIGN NAME HERE
  set design_name riscWithPipeMem
  ...
  # Create ports
  set dataToReg [ create_bd_port -dir O -from 31 -to 0 dataToReg ]
  set rd [ create_bd_port -dir O -from 4 -to 0 rd ]
  set regWrite [ create_bd_port -dir O regWrite ]
  set reset [ create_bd_port -dir I reset ]
  set toEdge01 [ create_bd_port -dir O -from 31 -to 0 toEdge01 ]
  set clk [ create_bd_port -dir I -type clk -freq_hz 100000000 clk ]
  set stall [ create_bd_port -dir I stall ]
  set memToEdge [ create_bd_port -dir O -from 31 -to 0 memToEdge ]
  set pc [ create_bd_port -dir O -from 31 -to 0 pc ]
  set instr [ create_bd_port -dir O -from 31 -to 0 instr ]

  # Create instance: aluMuxComb_0, and set properties
  set block_name aluMuxComb
  set block_cell_name aluMuxComb_0
  if { [catch {set aluMuxComb_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $aluMuxComb_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: opLatch_0, and set properties
  set block_name opLatch
  set block_cell_name opLatch_0
  if { [catch {set opLatch_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $opLatch_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: resetManager_0, and set properties
  set block_name resetManager
  set block_cell_name resetManager_0
  if { [catch {set resetManager_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $resetManager_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: writeBackLatch_0, and set properties
  set block_name writeBackLatch
  set block_cell_name writeBackLatch_0
  if { [catch {set writeBackLatch_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $writeBackLatch_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: memFetchLatch_0, and set properties
  set block_name memFetchLatch
  set block_cell_name memFetchLatch_0
  if { [catch {set memFetchLatch_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $memFetchLatch_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: bypassMux_0, and set properties
  set block_name bypassMux
  set block_cell_name bypassMux_0
  if { [catch {set bypassMux_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bypassMux_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: new_reg_file_0, and set properties
  set block_name new_reg_file
  set block_cell_name new_reg_file_0
  if { [catch {set new_reg_file_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $new_reg_file_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: execLatch_0, and set properties
  set block_name execLatch
  set block_cell_name execLatch_0
  if { [catch {set execLatch_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $execLatch_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: bytewrite_tdp_ram_rf_0, and set properties
  set block_name bytewrite_tdp_ram_rf
  set block_cell_name bytewrite_tdp_ram_rf_0
  if { [catch {set bytewrite_tdp_ram_rf_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bytewrite_tdp_ram_rf_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: memInputLogic_0, and set properties
  set block_name memInputLogic_
  set block_cell_name memInputLogic_0
  if { [catch {set memInputLogic_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $memInputLogic_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: memOutputLogic_0, and set properties
  set block_name memOutputLogic
  set block_cell_name memOutputLogic_0
  if { [catch {set memOutputLogic_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $memOutputLogic_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: pcAlu_0, and set properties
  set block_name pcAlu
  set block_cell_name pcAlu_0
  if { [catch {set pcAlu_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pcAlu_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: pcMuxSelector_0, and set properties
  set block_name pcMuxSelector
  set block_cell_name pcMuxSelector_0
  if { [catch {set pcMuxSelector_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pcMuxSelector_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create port connections
  connect_bd_net -net Decode_0_aluOp [get_bd_pins Decode_0/aluOp] [get_bd_pins opLatch_0/aluOpIn]
  connect_bd_net -net Decode_0_aluToReg [get_bd_pins Decode_0/aluToReg] [get_bd_pins opLatch_0/aluToRegIn]
  connect_bd_net -net Decode_0_branch [get_bd_pins Decode_0/branch] [get_bd_pins opLatch_0/branchIn]
  connect_bd_net -net Decode_0_imm [get_bd_pins Decode_0/imm] [get_bd_pins opLatch_0/immIn]
  connect_bd_net -net Decode_0_jal [get_bd_pins Decode_0/jal] [get_bd_pins opLatch_0/jalIn]
  connect_bd_net -net Decode_0_jalr [get_bd_pins Decode_0/jalr] [get_bd_pins opLatch_0/jalrIn]
  connect_bd_net -net Decode_0_memOp [get_bd_pins Decode_0/memOp] [get_bd_pins opLatch_0/memOpIn]
  connect_bd_net -net Decode_0_memSize [get_bd_pins Decode_0/memSize] [get_bd_pins opLatch_0/memSizeIn]
  connect_bd_net -net Decode_0_pc [get_bd_pins Decode_0/pc] [get_bd_pins opLatch_0/pcIn]
  connect_bd_net -net Decode_0_rd [get_bd_pins Decode_0/rd] [get_bd_pins opLatch_0/rdIn]
  connect_bd_net -net Decode_0_rs1 [get_bd_pins Decode_0/rs1] [get_bd_pins new_reg_file_0/rd1_addr]
  connect_bd_net -net Decode_0_rs2 [get_bd_pins Decode_0/rs2] [get_bd_pins new_reg_file_0/rd2_addr]
  connect_bd_net -net Decode_0_selA [get_bd_pins Decode_0/selA] [get_bd_pins opLatch_0/selAIn]
  connect_bd_net -net Decode_0_selB [get_bd_pins Decode_0/selB] [get_bd_pins opLatch_0/selBIn]
  connect_bd_net -net PC_0_enA [get_bd_pins PC_0/enA] [get_bd_pins bytewrite_tdp_ram_rf_0/enaA]
  connect_bd_net -net PC_0_pc [get_bd_pins PC_0/pc] [get_bd_pins memFetchLatch_0/pcIn] [get_bd_ports pc]
  connect_bd_net -net PC_0_pcForMem [get_bd_pins PC_0/pcForMem] [get_bd_pins bytewrite_tdp_ram_rf_0/addrA]
  connect_bd_net -net aluMuxComb_0_a [get_bd_pins aluMuxComb_0/a] [get_bd_pins alu_0/a]
  connect_bd_net -net aluMuxComb_0_b [get_bd_pins aluMuxComb_0/b] [get_bd_pins alu_0/b]
  connect_bd_net -net alu_0_aluOut [get_bd_pins alu_0/aluOut] [get_bd_pins execLatch_0/aluIn] [get_bd_pins memInputLogic_0/addr] [get_bd_pins pcMuxSelector_0/aluOut]
  connect_bd_net -net bypassMux_0_r1Val [get_bd_pins bypassMux_0/r1Val] [get_bd_pins aluMuxComb_0/rs1Val] [get_bd_pins pcAlu_0/r1]
  connect_bd_net -net bypassMux_0_r2Val [get_bd_pins bypassMux_0/r2Val] [get_bd_pins aluMuxComb_0/rs2Val] [get_bd_pins memInputLogic_0/rawDin]
  connect_bd_net -net bytewrite_tdp_ram_rf_0_doutA [get_bd_pins bytewrite_tdp_ram_rf_0/doutA] [get_bd_pins memOutputLogic_0/instrMemRead]
  connect_bd_net -net bytewrite_tdp_ram_rf_0_doutB [get_bd_pins bytewrite_tdp_ram_rf_0/doutB] [get_bd_pins memOutputLogic_0/rawMemRead]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins opLatch_0/clk] [get_bd_pins writeBackLatch_0/clk] [get_bd_pins Decode_0/clk] [get_bd_pins memFetchLatch_0/clk] [get_bd_pins new_reg_file_0/clk] [get_bd_pins PC_0/clk] [get_bd_pins execLatch_0/clk] [get_bd_pins bytewrite_tdp_ram_rf_0/clk] [get_bd_pins memInputLogic_0/clk]
  connect_bd_net -net execLatch_0_alu [get_bd_pins execLatch_0/alu] [get_bd_pins writeBackLatch_0/aluIn] [get_bd_pins bypassMux_0/execAluVal] [get_bd_pins memOutputLogic_0/addr]
  connect_bd_net -net execLatch_0_aluToReg [get_bd_pins execLatch_0/aluToReg] [get_bd_pins writeBackLatch_0/aluToRegIn] [get_bd_pins bypassMux_0/execRegWrite]
  connect_bd_net -net execLatch_0_memOpOut [get_bd_pins execLatch_0/memOpOut] [get_bd_pins memOutputLogic_0/memOp]
  connect_bd_net -net execLatch_0_memSizeOut [get_bd_pins execLatch_0/memSizeOut] [get_bd_pins memOutputLogic_0/memSize]
  connect_bd_net -net execLatch_0_rd [get_bd_pins execLatch_0/rd] [get_bd_pins writeBackLatch_0/rdIn] [get_bd_pins bypassMux_0/execRd]
  connect_bd_net -net fakeMemIO_0_doutB [get_bd_pins memOutputLogic_0/dout] [get_bd_pins writeBackLatch_0/memIn] [get_bd_pins bypassMux_0/execMemVal]
  connect_bd_net -net inferredBRAM_0_doutA [get_bd_pins memOutputLogic_0/instrDout] [get_bd_pins Decode_0/instruction] [get_bd_ports instr]
  connect_bd_net -net memFetchLatch_0_pc [get_bd_pins memFetchLatch_0/pc] [get_bd_pins Decode_0/pc_in]
  connect_bd_net -net memInputLogic_0_addrB [get_bd_pins memInputLogic_0/addrB] [get_bd_pins bytewrite_tdp_ram_rf_0/addrB]
  connect_bd_net -net memInputLogic_0_dinToMem [get_bd_pins memInputLogic_0/dinToMem] [get_bd_pins bytewrite_tdp_ram_rf_0/dinB]
  connect_bd_net -net memInputLogic_0_enaB [get_bd_pins memInputLogic_0/enaB] [get_bd_pins bytewrite_tdp_ram_rf_0/enaB]
  connect_bd_net -net memInputLogic_0_memToEdge [get_bd_pins memInputLogic_0/memToEdge] [get_bd_ports memToEdge]
  connect_bd_net -net memInputLogic_0_weB [get_bd_pins memInputLogic_0/weB] [get_bd_pins bytewrite_tdp_ram_rf_0/weB]
  connect_bd_net -net memOutputLogic_0_readValid [get_bd_pins execLatch_0/doutBValid] [get_bd_pins writeBackLatch_0/memValidIn] [get_bd_pins bypassMux_0/execMemValid]
  connect_bd_net -net new_reg_file_0_rd1_addr_out [get_bd_pins new_reg_file_0/rd1_addr_out] [get_bd_pins bypassMux_0/ra1]
  connect_bd_net -net new_reg_file_0_rd1_data [get_bd_pins new_reg_file_0/rd1_data] [get_bd_pins bypassMux_0/r1RegVal]
  connect_bd_net -net new_reg_file_0_rd2_addr_out [get_bd_pins new_reg_file_0/rd2_addr_out] [get_bd_pins bypassMux_0/ra2]
  connect_bd_net -net new_reg_file_0_rd2_data [get_bd_pins new_reg_file_0/rd2_data] [get_bd_pins bypassMux_0/r2RegVal]
  connect_bd_net -net opLatch_0_aluOp [get_bd_pins opLatch_0/aluOp] [get_bd_pins alu_0/aluOp]
  connect_bd_net -net opLatch_0_aluToReg [get_bd_pins opLatch_0/aluToReg] [get_bd_pins execLatch_0/aluToRegIn]
  connect_bd_net -net opLatch_0_branch [get_bd_pins opLatch_0/branch] [get_bd_pins pcMuxSelector_0/branch]
  connect_bd_net -net opLatch_0_imm [get_bd_pins opLatch_0/imm] [get_bd_pins aluMuxComb_0/imm] [get_bd_pins pcAlu_0/imm]
  connect_bd_net -net opLatch_0_jal [get_bd_pins opLatch_0/jal] [get_bd_pins pcMuxSelector_0/jal]
  connect_bd_net -net opLatch_0_jalr [get_bd_pins opLatch_0/jalr] [get_bd_pins pcAlu_0/jalr] [get_bd_pins pcMuxSelector_0/jalr]
  connect_bd_net -net opLatch_0_memOp [get_bd_pins opLatch_0/memOp] [get_bd_pins execLatch_0/memOp] [get_bd_pins memInputLogic_0/memOp]
  connect_bd_net -net opLatch_0_memSize [get_bd_pins opLatch_0/memSize] [get_bd_pins execLatch_0/memSize] [get_bd_pins memInputLogic_0/memSize]
  connect_bd_net -net opLatch_0_pc [get_bd_pins opLatch_0/pc] [get_bd_pins aluMuxComb_0/pc] [get_bd_pins pcAlu_0/pc]
  connect_bd_net -net opLatch_0_rd [get_bd_pins opLatch_0/rd] [get_bd_pins execLatch_0/rdIn]
  connect_bd_net -net opLatch_0_selA [get_bd_pins opLatch_0/selA] [get_bd_pins aluMuxComb_0/selA]
  connect_bd_net -net opLatch_0_selB [get_bd_pins opLatch_0/selB] [get_bd_pins aluMuxComb_0/selB]
  connect_bd_net -net orGate_0_y [get_bd_ports stall] [get_bd_pins writeBackLatch_0/stall] [get_bd_pins opLatch_0/stall] [get_bd_pins Decode_0/stall] [get_bd_pins memFetchLatch_0/stall] [get_bd_pins PC_0/stall] [get_bd_pins execLatch_0/stall]
  connect_bd_net -net pcAlu_0_jumpPc [get_bd_pins pcAlu_0/jumpPc] [get_bd_pins PC_0/jumpVect]
  connect_bd_net -net pcMuxSelector_0_jumpEn [get_bd_pins pcMuxSelector_0/jumpEn] [get_bd_pins resetManager_0/jumpEn] [get_bd_pins PC_0/jumpEn]
  connect_bd_net -net resetManager_0_flushReset [get_bd_pins resetManager_0/flushReset] [get_bd_pins opLatch_0/reset] [get_bd_pins Decode_0/resetFlush]
  connect_bd_net -net resetManager_0_mainReset [get_bd_pins resetManager_0/mainReset] [get_bd_pins writeBackLatch_0/reset] [get_bd_pins Decode_0/reset] [get_bd_pins memFetchLatch_0/reset] [get_bd_pins new_reg_file_0/rst] [get_bd_pins PC_0/reset] [get_bd_pins execLatch_0/reset] [get_bd_pins memInputLogic_0/reset]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins resetManager_0/reset]
  connect_bd_net -net writeBackLatch_0_dataToReg [get_bd_pins writeBackLatch_0/dataToReg] [get_bd_pins bypassMux_0/wbVal] [get_bd_pins new_reg_file_0/wr_data]
  connect_bd_net -net writeBackLatch_0_rd [get_bd_pins writeBackLatch_0/rd] [get_bd_pins bypassMux_0/wbRd] [get_bd_pins new_reg_file_0/wr_addr]
  connect_bd_net -net writeBackLatch_0_regWrite [get_bd_pins writeBackLatch_0/regWrite] [get_bd_pins bypassMux_0/wbRegWrite] [get_bd_pins new_reg_file_0/wr_en]
...
# End of cr_bd_riscWithPipeMem()
cr_bd_riscWithPipeMem ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files riscWithPipeMem.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files riscWithPipeMem.bd ] 
set_property IS_ENABLED "1" [get_files riscWithPipeMem.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files riscWithPipeMem.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files riscWithPipeMem.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files riscWithPipeMem.bd ] 
set_property PFM_NAME "" [get_files riscWithPipeMem.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files riscWithPipeMem.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files riscWithPipeMem.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files riscWithPipeMem.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files riscWithPipeMem.bd ] 
set_property USED_IN_SIMULATION "1" [get_files riscWithPipeMem.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files riscWithPipeMem.bd ] 
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/riscv2.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/riscv2.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/riscv2.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
