...
#
# Script generated by Vivado on Wed Dec 25 09:06:52 +0000 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : DualBRAM.sh
...
#
# Usage        : DualBRAM.sh
#                DualBRAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DualBRAM.sh [-reset_run]
#                DualBRAM.sh [-reset_log]
#                DualBRAM.sh [-help]
#
...
#                script (type 'DualBRAM.sh -help' for more information).
#
...
# script info
echo -e "DualBRAM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DualBRAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DualBRAM xil_defaultlib.glbl -o DualBRAM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DualBRAM_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/user/project/riscv2/riscv2.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key DualBRAM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DualBRAM_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DualBRAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DualBRAM.sh [-help]\n\
Usage: DualBRAM.sh [-step]\n\
Usage: DualBRAM.sh [-lib_map_path]\n\
Usage: DualBRAM.sh [-reset_run]\n\
Usage: DualBRAM.sh [-reset_log]\n\
Usage: DualBRAM.sh [-keep_index]\n\
Usage: DualBRAM.sh [-noclean_files]\n\n\
